        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              ...
              <p className="mb-6">
                Unsere Kernwerte prägen jeden Aspekt unserer Arbeit: Transparenz in der Kommunikation, Exzellenz in der Ausführung und ein unermüdliches Streben nach Innovation. Wir setzen auf nachhaltige Linkbuilding-Strategien, die langfristigen Erfolg garantieren, entwickeln sichere und skalierbare Softwarelösungen und implementieren KI-Systeme unter Berücksichtigung ethischer Richtlinien.
              </p>
              <p>
